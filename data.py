...
all_years = soup.find_all('spam', attrs={'class' : 'vehicle-card-year text-xs'}, limit= 20)

DB_name = 'mainDB'

TABLES = {}
TABLES['car'] = ('CREATE TABLE car(Price CHAR(20), Miles CHAR(30), Year CHAR(20))')
...
# appendding price's and mile's amount to lists
price_list = []
...
for i in range(20):
    ...
    info_list.append(years_list[i])
    print(info_list)
    add_price = ("INSERT INTO car(Price, Miles, Years) VALUES( %s, %s, %s)")
